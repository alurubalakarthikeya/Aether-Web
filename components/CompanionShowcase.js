...
export default function CompanionShowcase() {
    return (
        <section className="relative px-6 lg:px-12 py-24 lg:py-20 lg:bg-transparent overflow-hidden" id="companion">
            <div className="max-w-[480px] lg:max-w-[600px] mx-auto w-full relative z-10">
                ...
                <div className="relative z-10 flex flex-col items-center gap-12">
                    ...
                    <motion.div
                        ...
                        className="w-full max-w-[440px] lg:scale-[0.85] glass-heavy p-1 rounded-[40px] relative overflow-hidden mx-auto lg:mx-0 shadow-[0_32px_64px_-16px_rgba(43,85,72,0.25)] will-change-transform lg:order-1 origin-top"
                    >
