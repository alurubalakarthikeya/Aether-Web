...
export default function AppPreview() {
    return (
        <section className="relative px-6 lg:px-12 py-24 lg:py-20 lg:bg-transparent overflow-hidden" id="preview">
            {/* Ambient Background - Hidden on Desktop grid for unity */}
            ...
            <div className="max-w-[480px] lg:max-w-[600px] mx-auto w-full relative z-10">
                ...
                >
                    <h2 className="text-[28px] lg:text-[34px] text-teal leading-tight mb-4 lg:mb-6 px-4">A space that<br />listens to you.</h2>
                ...
                <div className="relative w-full h-[540px] flex flex-col items-center scale-90 lg:scale-[0.82] transition-transform origin-top">
                    {/* 1. Main Phone Mockup */}
                    <motion.div
